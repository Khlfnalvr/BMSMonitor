...
/// extracts SOC-relevant fields. Compatible with the BMS firmware protocol v1.
/// Expected JSON keys: { "v":1, "soc":..., "pack_v":..., "current":..., "status":"..." }
/// </summary>
public class SerialPortService : IDisposable
{
    ...
    public event Action<SocData>? DataReceived;
    ...
    private static SocData? TryParseFrame(string json)
    {
        try
        {
